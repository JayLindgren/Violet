...
//
   ...
   {
      if (argsBoard->siNumberOfMoves >= dNumberOfMoves) break; // Bounds check
                   ...
                   struct GeneralMove * argsGeneralMoves )
{
   ...
   if ( iBookMove == -1 && GetInterfaceMode() == dUCI )
   {
   ...
   if ( GetInterfaceMode() == dConsole )
   {
      ...
      if ( iBookMove == -1 )
      {
         ...
         {
             cout << endl << "ERROR: Search completed but PV is invalid - cannot make move!" << endl;
             cout << "PV[0][0]: from=" << argsBoard->vmPrincipalVariation[0][0].iFromSquare 
                  << " to=" << argsBoard->vmPrincipalVariation[0][0].iToSquare << endl << endl;
         }
         //cout << strMove << endl;
                      ...
                      int siSide ) 
{
   ...
   if ( siSide == dWhite ) 
   {
      ...
      { 
         int iCand = iSquare - 9;
         if ( iCand >= 0 && ( argsBoard->bbWhitePawn & ( 1ULL << iCand ) ) ) return 1;
      }
   ...
   else 
   {
      ...
      {
         int iCand = iSquare + 9;
         if ( iCand < 64 && ( argsBoard->bbBlackPawn & ( 1ULL << iCand ) ) ) return 1;
      }
   ...
   if ( bbKnights & argsGeneralMoves->bbNMove[ iSquare ] ) return 1;
   ...
   if ( bbBishops )
   {
       // Check rays
       // NorthEast
       int siLen = argsGeneralMoves->vBNOMNE[ iSquare ];
       for ( int i = 0; i < siLen; ++i ) 
       {
          int iSq = argsGeneralMoves->mBNE[ iSquare ][ i ];
          if ( argsBoard->bbAllPieces & ( 1ULL << iSq ) ) 
          {
             if ( bbBishops & ( 1ULL << iSq ) ) return 1;
             break; // Blocked
          }
       }
       // NorthWest
       int siLenNW = argsGeneralMoves->vBNOMNW[ iSquare ];
       for ( int i = 0; i < siLenNW; ++i ) 
       {
          int iSq = argsGeneralMoves->mBNW[ iSquare ][ i ];
          if ( argsBoard->bbAllPieces & ( 1ULL << iSq ) ) 
          {
             if ( bbBishops & ( 1ULL << iSq ) ) return 1;
             break; // Blocked
       ...
       // SouthEast
       int siLenSE = argsGeneralMoves->vBNOMSE[ iSquare ];
       for ( int i = 0; i < siLenSE; ++i ) 
       {
          int iSq = argsGeneralMoves->mBSE[ iSquare ][ i ];
          if ( argsBoard->bbAllPieces & ( 1ULL << iSq ) ) 
          {
             if ( bbBishops & ( 1ULL << iSq ) ) return 1;
             break; // Blocked
       ...
       // SouthWest
       int siLenSW = argsGeneralMoves->vBNOMSW[ iSquare ];
       for ( int i = 0; i < siLenSW; ++i ) 
       {
          int iSq = argsGeneralMoves->mBSW[ iSquare ][ i ];
          if ( argsBoard->bbAllPieces & ( 1ULL << iSq ) ) 
          {
             if ( bbBishops & ( 1ULL << iSq ) ) return 1;
             break; // Blocked
   ...
   {
       // North
       int siLen = argsGeneralMoves->vRNOMN[ iSquare ];
       for ( int i = 0; i < siLen; ++i ) 
       {
          int iSq = argsGeneralMoves->mRN[ iSquare ][ i ];
          if ( argsBoard->bbAllPieces & ( 1ULL << iSq ) ) 
          {
             if ( bbRooks & ( 1ULL << iSq ) ) return 1;
             break; // Blocked
          }
       }
       // South
       int siLenS = argsGeneralMoves->vRNOMS[ iSquare ];
       for ( int i = 0; i < siLenS; ++i ) 
       {
          int iSq = argsGeneralMoves->mRS[ iSquare ][ i ];
          if ( argsBoard->bbAllPieces & ( 1ULL << iSq ) ) 
          {
             if ( bbRooks & ( 1ULL << iSq ) ) return 1;
             break; // Blocked
       ...
       // East
       int siLenE = argsGeneralMoves->vRNOME[ iSquare ];
       for ( int i = 0; i < siLenE; ++i ) 
       {
          int iSq = argsGeneralMoves->mRE[ iSquare ][ i ];
          if ( argsBoard->bbAllPieces & ( 1ULL << iSq ) ) 
          {
             if ( bbRooks & ( 1ULL << iSq ) ) return 1;
             break; // Blocked
       ...
       // West
       int siLenW = argsGeneralMoves->vRNOMW[ iSquare ];
       for ( int i = 0; i < siLenW; ++i ) 
       {
          int iSq = argsGeneralMoves->mRW[ iSquare ][ i ];
          if ( argsBoard->bbAllPieces & ( 1ULL << iSq ) ) 
          {
             if ( bbRooks & ( 1ULL << iSq ) ) return 1;
             break; // Blocked
   ...
   if ( bbKing & argsGeneralMoves->bbKMove[ iSquare ] ) return 1;
