...
//
// This file contains all definitions except for those associated iwth the
// evaluation. Please see Evaluaction.cpp for those values.
//
//
// Some Board notes.
// Cols ---->
...
// Turn on deep mode
// #define dDeepMode 1  -- Deprecated in favor of std::thread / Lazy SMP
#define dUseHash 1
#define dUseNull 1
#define dUseFutility 1
#define dFutilityDepth 4
#define dFutilityMargin 300

// Singular Extensions Parameters
#define dSingularMinDepth 10 // Only perform SE at depth 10+ (increased to prevent explosion)
#define dSingularMargin 1    // Score margin (centipawns) for singularity (reduced to trigger more often)
#define dSingularDepthRed 2  // Depth reduction divisor for verification search

// Reverse Futility Pruning (Static Null Move Pruning) Parameters
#define dUseRFP 1      // Master toggle
#define dRfpDepth 6    // Only prune if remaining depth is <= 6
#define dRfpMargin 100 // Safety margin in centipawns per ply (depth * 100)

#define dAspiration 1
#define dUseNNUE 1
// # define dNNUEFile    "nn-04cf2b4ed1da.nnue"  // Old HalfKP network (Oct 2020)
#define dNNUEFile "C:\\VioletTools\\nn-62ef826d1a6d.nnue" // Stockfish 13 HalfKP network (Feb 2021)
...
#define dTrimBook 22    // Trims the opening book.
#define dExploreBook 23 // Explore the opening book.
#define dTune 13        // Used for tuning parameters
#define dTestNNUE 14    // Test NNUE accumulator
#define dTestHashPerformance 15
#define dTestNullMovePerformance 16
#define dTestAspirationPerformance 17 // Test aspiration search performance
#define dTestMoveOrdering 18
#define dTestSEE 19
#define dTestThreefoldRepetition 20
#define dTestWAC 21
#define dTestSingularExtension 24 // Test SE with Arasan Break position
#define dVFE_Mode 25

// Move Ordering Modes
#define dMoveOrderingA 0
#define dMoveOrderingB 1
...
//  The idea of this calculation is to precalculate all of the possible moves
//  for every piece
...
// Define the pieces.
// The code assumes that the black pieces have a higher number than the white
// pieces. Further it assumes that the white king is the highest numbered white
// piece and that the black pawn is the lowest numbered black piece.
#define dEmpty 0
#define dWhitePawn 1
#define dWhiteRook 2
...
// Misc parameters.
#define dNumberOfMoves 218
#define dNumberOfMoveHistory 2048
#define dNumberOfPlys 100
...
#define dNumberOfBitsInOpeningBook 28 // Increased for 4.5M games
...
/////////////////////////////////////////////////
// SEE-Enhanced Move Scoring Hierarchy
// Used by SortMovesHashB for optimal move ordering
/////////////////////////////////////////////////

// Hash Move (always searched first)
#define dsHashMove 2000000

// Good Captures (SEE >= 0): Base score + SEE value weighted + MVV/LVA
#define dsGoodCaptureBase 1000000

// Killer Moves (non-capture moves that caused beta cutoffs)
#define dsKillerMove1 900000
#define dsKillerMove2 890000

// Quiet Moves (History Heuristic): 0 to dsHistoryScoreMax
#define dsHistoryScoreMax 500000

// Bad Captures (SEE < 0): Negative base + SEE recovery
// These are searched last, after all quiet moves
#define dsBadCaptureBase -1000000

/////////////////////////////////////////////////
// Enhanced LMR: History Heuristic Thresholds
/////////////////////////////////////////////////
#define HISTORY_GOOD_THRESHOLD 8000 // Reduce less for moves with good history
#define HISTORY_BAD_THRESHOLD 2000  // Reduce more for moves with bad history
...
// Define the value of the remaining plys to the Q search with no forward
// prunning
#define dPruneCutOff 6

// Define the window for the aspirational search window.
// # define dAspirationalWindowWidth 30
extern int giAspirationWindowWidth;

///////////////////////////////////////////////////////////////////////////////////////////////////////
// Define some evaluation parameters
//////////////////////////////////////////////////////////////////////////////////////////////////////

// Define the doubled pawn score. - Note, these score get counted twice (one for
// each pawn).
