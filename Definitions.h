...
#define dUseNNUE 1
// # define dNNUEFile    "nn-04cf2b4ed1da.nnue"
...
#define dTestNullMovePerformance 16   // Test hashtable performance analysis
...
#define dNumberOfBitsInOpeningBook                                             \
  22 // Changing this requres redoing the entire opening book.
// # define dHashTableSize   ( dNumberOfBitsInHash^2 - 1 ) // 2^20 - 1  This
// should be controlled by sGeneralMove->bbKey1 check bbKey2. # define
// dOpeningBookSize ( dNumberOfBitsInHash^2 - 1 ) // 2^20 - 1 # define
// dHashTableSize 1048575 // 2^20 - 1 # define dOpeningBookSize 1048575 // 2^20
// - 1
...
#define dsCastle                                                               \
  99 // 400 253864, 1600 257155, 299 252921, 199 253024, 99 251,519
...
#define dPopularityCutOff                                                      \
  0.9                   // used for going after only the most popular moves.
...
#define dMoveUpdateTime                                                        \
  2000 // Defines how frequently we update the move being searched to the
       // interface.
