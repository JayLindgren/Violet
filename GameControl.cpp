...
/*
   ...
   SetModeOfPlay(          dSetUp );          // dGame dSetUp dComputerGame dBookProbe dTestSuite dTestEval dTune
                                              // dTestDraw dCheckBook dTestHash dUserSetUp dTestNull
   SetUseOpeningBook(      dYes );            // dYes dNo
   SetComputerColor(       dComputerBlack ); // dComputerWhite dComputerBlack
   SetInterfaceMode(       dConsole );       // dConsole dUCI dXboard
//*/
/*
   // Set the initial parameters for controling the gamee4
   SetSearchDepth(             8 ); // dInfiniteDepth dOpeningBookVerificationSearchDepth
   SetSearchTimeInMiliSeconds( dInfiniteTime ); // dInfiniteTime dOneSecond dTwentySeconds dOneMinute dTenMinutes

   // Type of game to play.
   SetModeOfPlay(          dTune );          // dGame dSetUp dComputerGame dBookProbe dTestSuite dTestEval dTune
                                              // dTestDraw dCheckBook dTestHash dUserSetUp dTestNull
   SetUseOpeningBook(      dYes );            // dYes dNo
   SetComputerColor(       dComputerBlack ); // dComputerWhite dComputerBlack
   SetInterfaceMode(       dConsole );       // dConsole dUCI dXboard
...
///*
   // Set the initial parameters for controling the gamee4
   SetSearchDepth(             12 ); // dInfiniteDepth dOpeningBookVerificationSearchDepth
   SetSearchTimeInMiliSeconds( dInfiniteTime ); // dInfiniteTime dOneSecond dTwentySeconds dOneMinute dTenMinutes
...
/*
   ...
   // Type of game to play.
   SetModeOfPlay(          dTestSuite );          // dGame dSetUp dComputerGame dBookProbe dTestSuite dTestEval 
                                              // dTestDraw dCheckBook dTestHash dUserSetUp dTestNull
   SetUseOpeningBook(      dYes );            // dYes dNo
   SetComputerColor(       dComputerBlack ); // dComputerWhite dComputerBlack
   SetInterfaceMode(       dConsole );       // dConsole dUCI dXboard
