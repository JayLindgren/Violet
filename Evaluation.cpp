...
int CountPiecesAndEvaluatePosition(struct Board *argsBoard,
  ...
  for (iSquareIndex = 0; iSquareIndex < 64; iSquareIndex++) {
    ...
    case dWhiteRook: {
      ...
      // Value a king attack
      if ((argsGeneralMoves->bbRMove[iSquareIndex] &
           argsGeneralMoves->bbKingBubble[iBlackKingSquare]) > 0) {
    ...
    case dWhiteBishop: {
      ...
      // Value a king attack
      if ((argsGeneralMoves->bbBMove[iSquareIndex] &
           argsGeneralMoves->bbKingBubble[iBlackKingSquare]) > 0) {
    ...
    case dWhiteQueen: {
      ...
      // Value a king attack
      if ((argsGeneralMoves->bbQMove[iSquareIndex] &
           argsGeneralMoves->bbKingBubble[iBlackKingSquare]) > 0) {
...
int RookMobility(struct Board *argsBoard, struct GeneralMove *argsGeneralMoves,
  ...
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mRN[argiSquareIndex],
      argsGeneralMoves->vQNOMN[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mRE[argiSquareIndex],
      argsGeneralMoves->vQNOME[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mRS[argiSquareIndex],
      argsGeneralMoves->vQNOMS[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mRW[argiSquareIndex],
      argsGeneralMoves->vQNOMW[argiSquareIndex], argiSquareIndex);
...
int BishopMobility(struct Board *argsBoard,
  ...
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mBNE[argiSquareIndex],
      argsGeneralMoves->vQNOMNE[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mBSE[argiSquareIndex],
      argsGeneralMoves->vQNOMSE[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mBSW[argiSquareIndex],
      argsGeneralMoves->vQNOMSW[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mBNW[argiSquareIndex],
      argsGeneralMoves->vQNOMNW[argiSquareIndex], argiSquareIndex);
...
int QueenMobility(struct Board *argsBoard, struct GeneralMove *argsGeneralMoves,
  ...
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mQN[argiSquareIndex],
      argsGeneralMoves->vQNOMN[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mQNE[argiSquareIndex],
      argsGeneralMoves->vQNOMNE[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mQE[argiSquareIndex],
      argsGeneralMoves->vQNOME[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mQSE[argiSquareIndex],
      argsGeneralMoves->vQNOMSE[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mQS[argiSquareIndex],
      argsGeneralMoves->vQNOMS[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mQSW[argiSquareIndex],
      argsGeneralMoves->vQNOMSW[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mQW[argiSquareIndex],
      argsGeneralMoves->vQNOMW[argiSquareIndex], argiSquareIndex);
  iNumberOfMoves += SliderMobility(
      argsBoard, argsGeneralMoves->mQNW[argiSquareIndex],
      argsGeneralMoves->vQNOMNW[argiSquareIndex], argiSquareIndex);
...
//-------------------------------------------------------------------------------------------------------------
//
int GetValueOfDraw() { return dDrawValue; }
...
int GetUseMobility() { return gsEvaluator.iUseMobility; }

//
////////////////////////////////////////////////////////////////////////////////////////////////////
//
void SetUseMobility(int iMobility) { gsEvaluator.iUseMobility = iMobility; }
