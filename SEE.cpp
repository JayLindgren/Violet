                         ...
                         int & iAttackerPiece ) 
{
   ...
   if ( bbBishops ) 
   {
      ...
      for ( int i = 0; i < siLen; ++i ) 
      {
         ...
         if ( bbOccupied & ( 1ULL << iSq ) ) 
         {
            if ( bbBishops & ( 1ULL << iSq ) ) 
            {
               int iPiece = argsBoard->mBoard[ iSq ];
               if ( iPiece == dWhiteBishop || iPiece == dBlackBishop )
               {
                  iAttackerSq = iSq;
                  iAttackerPiece = iPiece;
                  return iPiece;
               }
               else
               {
                  // It's a Queen. Store it but keep looking for a Bishop.
                  if ( iFoundQueenSq == -1 )
                  {
                      iFoundQueenSq = iSq;
                      iFoundQueenPiece = iPiece;
                  }
               }
            }
            break; // Blocked
      ...
      // NorthWest
      siLen = argsGeneralMoves->vBNOMNW[ iSquare ];
      for ( int i = 0; i < siLen; ++i ) 
      {
      ...
      // SouthEast
      siLen = argsGeneralMoves->vBNOMSE[ iSquare ];
      for ( int i = 0; i < siLen; ++i ) 
      {
      ...
      // SouthWest
      siLen = argsGeneralMoves->vBNOMSW[ iSquare ];
      for ( int i = 0; i < siLen; ++i ) 
      {
   ...
   if ( bbRooks ) 
   {
      ...
      // South
      siLen = argsGeneralMoves->vRNOMS[ iSquare ];
      for ( int i = 0; i < siLen; ++i ) 
      {
      ...
      // East
      siLen = argsGeneralMoves->vRNOME[ iSquare ];
      for ( int i = 0; i < siLen; ++i ) 
      {
      ...
      // West
      siLen = argsGeneralMoves->vRNOMW[ iSquare ];
      for ( int i = 0; i < siLen; ++i ) 
      {
